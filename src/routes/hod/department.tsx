    ...
    <RoleGuard allowedRoles={["hod"]}>
      <div className="space-y-6">
        <PageHeader
          ...
          description="Computer Science & Engineering Department Structure & Metrics."
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="card-surface p-6 rounded-2xl border border-border shadow-xs">
            <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider block">Total Students</span>
            <p className="text-3xl font-extrabold text-foreground mt-2">1,240</p>
          </div>
          <div className="card-surface p-6 rounded-2xl border border-border shadow-xs">
            <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider block">Faculty Members</span>
            <p className="text-3xl font-extrabold text-foreground mt-2">48</p>
          </div>
          <div className="card-surface p-6 rounded-2xl border border-border shadow-xs">
            <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider block">Active Classrooms</span>
